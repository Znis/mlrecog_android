...
//        gradientDrawable.cornerRadius = 30f
        ...
        dialog.setOnShowListener {
            ...
            val location: String = getDeviceLocation()
            val retrofit = Retrofit.Builder()
                .baseUrl("http://4.240.123.237:8000/")
...
//                        Toast.makeText(context, "$elapsedTime ms", Toast.LENGTH_SHORT).show()
                        ...
                        if (response.body() != null) {
                           val imgView: ImageView = (layout.getChildAt(0)) as ImageView
                            ...
                            myButton.setTextColor(Color.rgb(105,105,105))
//                            myButton.setTextSize(20f)
    ...
    private fun getDeviceLocation(): String {
        // Code to get device's current location goes here
        // Return a Location object with latitude and longitude
        // for example using LocationManager
        val locn = "(27.67141,85.42885)"
        return locn
    }
